			...
			<table cellspacing="0" class="shop_table cart">
                ...
                <tbody>
                    ...
                    <tr class="cart_item">
                        ...
                        <td><a href="freeboardDetail.do?boardIdx=${freeboard.boardIdx }">${freeboard.title }</a></td>
						...
						<nav>
							<ul class="pagination">
								<c:if test="${current != 1 }">
									<c:choose>
										<c:when test="${keyword == null }">
											<li><a href="freeboardMain.do?page=${current-1 }" aria-label="Previous"> <span
									...
									<c:choose>
										...
										<c:otherwise>
											<c:choose>
												...
												<c:otherwise>
													<li><a href="freeboardSearch.do?page=${page }&keyword=${keyword}&type=${type}">${page }</a></li>
												</c:otherwise>
											</c:choose>
										</c:otherwise>
									</c:choose>
								...
								<c:if test="${current != last }">
									<c:choose>
										<c:when test="${keyword == null }">
											<li><a href="freeboardMain.do?page=${current+1 }" aria-label="Next"> <span
											aria-hidden="true">&raquo;</span>
											</a></li>
										</c:when>
										<c:otherwise>
