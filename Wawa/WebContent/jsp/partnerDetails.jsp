...
<!-- 여기부터 안에 들어가면 안되는 이유찾기 -->
    <div class="single-product-area">
        ...
        <div class="container">
        	<div class="col-md-55">
        		<h2 class="sidebar-title">배우자를 찾습니다</h2>
                ...
                <h4 style="color: gray; text-align: center;">[제목] 배우자를 찾고 있습니다</h4>
                ...
                <input type="button" value="수정" onclick="location.href='/partnerUpdateForm.do'">
                <input type="button" value="삭제" onclick="location.href='/partnerDelete.do'">
                </div>
			</div>
		</div>
	</div>
