...
<!--                         <div class="woocommerce" > -->
                            ...
                            <form action="/Wawa/partnerUpdate.do" enctype="multipart/form-data" action="#" class="checkout" method="post" name="checkout">
                                    ...
                                    <h2 class="sidebar-title">글 수정하기</h2>
                                        <div class="woocommerce-billing-fields">
                                            ...
                                            <p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
                                                ...
                                                <input type="text" id="billing_state" name="age" placeholder="" value="" class="input-text ">
                                            </p>
                                            <br>
                                            <p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
                                                <label class="" for="billing_state">몸무게(kg)</label>
                                                <input type="text" id="billing_state" name="weight" placeholder="" value="" class="input-text ">
                                            </p>
                                            <br>
...
<!--<div class="clear"></div> -->
											...
											<div class="form-row place-order" style="float: right">
												<input type="button" id="delete"  onclick="location.href='/partnerDelete.do?boardIdx='#{boardIdx}''" value="DELETE" />
											</div>
