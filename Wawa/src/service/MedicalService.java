...
public class MedicalService implements IMedicalService {
	...
	public boolean insertMedicalcare(HashMap<String, Object> params) {
		...
		try {
			...
			if(vaccineType.equals("추가") || degree == 5 || (vaccineCode==2 && degree ==2)|| (vaccineCode==3 && degree ==2)|| vaccineCode == 4){
//			SimpleDateFormat transFormat = new SimpleDateFormat("yyyy-MM-dd");
				// 특정날짜에에 날짜(일수) 더하기
...
//	}
	...
	@Override
	public HashMap<String, Object> calculateNextSchedules(int petIdx) {//기초접종 예정일 계산하기
		...
		int[] firstVaccineAge ={42,42,70,98};// 종합백신 42 코로나 42 켄넬코프 70 광견병 98
...
//         특정날짜에에 날짜(일수) 더하기
	...
	public HashMap<String, Object> DDay(int petIdx) {
		...
		//System.out.println("Array1 : "+ arr[0] +"Array2 : "+ arr[1] +"Array3 : "+ arr[2] +"Array4 : "+ arr[3]);
		return DDay;
